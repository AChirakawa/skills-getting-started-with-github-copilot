...
activities = {
    ...
    "Soccer Practice": {
        "description": "Outdoor team training and friendly matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Basketball Team": {
        "description": "Learn team strategies and prepare for inter-school games",
    ...
    "Debate Team": {
        "description": "Build public speaking skills and prepare for debate competitions",
